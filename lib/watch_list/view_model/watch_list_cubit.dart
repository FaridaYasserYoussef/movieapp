...
class WatchListCubit extends Cubit<WatchListState> {
  ...
  WatchListCubit()
      : watchListrepository = WatchListRepository(
            dataSource: ServiceLocator.currentWatchListDataSource),
  ...
  Future addToWatchList(WatchListMovieModel movie) async {
    try {
      ...
      emit(AddMovieSuccessState(
          successMessage: "Movie added successfuly to watchlist"));
    } catch (errorMessage) {
  ...
  Future removeFromWatchList(String id) async {
    try {
      ...
      emit(RemoveMovieSuccessState(
          successMessage: "Movie removed Successfully from watchlist"));
    } catch (errorMessage) {
      emit(WatchListErrorState(errorMessage: errorMessage.toString()));
    }
  }
