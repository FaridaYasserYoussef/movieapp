  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
        Stack(
          children: [
            widget.movieModel.imageUrl == null
                ? Image.asset(
                    'assets/poster_not_found.jpg',
                    width: 175,
                    height: 130,
                  )
                : Padding(
            ...
            Positioned(
              ...
              child: CustomBookMarkWidget(
                onTap: () async {
                  ...
                  await watchListCubit
                      .removeFromWatchList(widget.movieModel.id!);
                },
              ),
            ),
          ],
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                (widget.movieModel.year).toString(),
                style: TextStyle(
                    fontSize: 13, color: Color.fromRGBO(255, 255, 255, 0.6745)),
              ),
              Text(widget.movieModel.artists!,
                  style: TextStyle(
                      fontSize: 13,
                      color: Color.fromRGBO(255, 255, 255, 0.6745)))
            ],
          ),
        )
      ]),
