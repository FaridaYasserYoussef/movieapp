        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text("Watchlist", style: TextStyle(color: Colors.white, fontSize: 22),),
            ),
            BlocProvider(
                  ...
                  return Center(
                    ...
                    if(state.watchListMovies.isEmpty){
                      return Padding(
                        ...
                        child: Center(
                          child: Text("No Movies in Watch list", style: TextStyle(color: Colors.white),)
                        ),
                      );
                    }
                      return   Expanded(
                        child: Padding(
                          ...
                          child: ListView.separated(
                                            itemBuilder: 
                                            (context, index){
                                           return WatchListItem(movieModel: state.watchListMovies[index]);
