              ...
              child: Column(
                ...
                validator: (p0) {
                 ...
                 BlocListener<AuthenticationCubit, AuthenticationState>(
                  child:   CustomFormButton(text: "Sign up",
                onTap: () async{
                  if(formkey.currentState!.validate()){
                    UserModel user = UserModel(email: emailController.text, name: nameController.text);
                    await authenticationCubit.signup(user, passwordController.text);
                  }
                },
                ),
                ...
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    }, child: Text("Login", style: TextStyle(color:AppColors.mainColor, fontWeight: FontWeight.bold, fontSize: 20),))
