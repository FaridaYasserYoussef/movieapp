...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(child:BlocProvider(create: (context) => authenticationCubit,
      child:  Column(
        children: [
         Padding(
           padding: const EdgeInsets.only(top:50.0),
           child: Center(child: Image(image: AssetImage("assets/movies.png"), height: 150,)),
         ),
           ...
           child: Form(
            ...
            child: Column(
              ...
              BlocListener<AuthenticationCubit, AuthenticationState>(
                child: CustomFormButton(text: "Login",
              onTap: () async{
                if(formkey.currentState!.validate()){
                  await authenticationCubit.login(emailController.text, passwordController.text);
                }
              },
              ),
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  }, child: Text("Sign up", style: TextStyle(color:AppColors.mainColor, fontWeight: FontWeight.bold, fontSize: 20),))
